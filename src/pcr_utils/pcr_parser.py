"""
PCR Parser - Extracts incident data from EMS dispatch PDFs using OpenAI Vision API.

This module provides PCRParser, a pure parsing class.
...
class PCRParser:
    ...
    def __init__(
        ...
        Args:
            api_key: OpenAI API key. If None, reads OPENAI_API_KEY env variable
            prompt_file: Path to prompt file. If None, uses default pcr_parse_prompt.md
            prompt_text: Full prompt string. If provided, overrides prompt_file.
